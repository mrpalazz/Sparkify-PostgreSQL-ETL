...
def process_song_file(cur, filepath):
    ...
    # this may contain multiple songs within the one file, loop through and add them to the structure
    #for index in df:
...
def process_log_file(cur, filepath):
    ...
    column_labels = ('Timestamp', 'Hour', 'Day', 'Week', 'Month', 'Year', 'Day_Name')
